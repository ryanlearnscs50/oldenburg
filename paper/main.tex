...
achieves the highest NHANES AUROC of 0.833.  For the SIN-specific item
(AUQ101, $\leq 2$), transfer AUROCs are somewhat lower but well above chance
(PTA4-only: 0.695; PTA4+Age: 0.744; matched HTL+Age: 0.763), consistent with
...
\midrule
PTA4 only              & 0.943 & 0.747 & 0.695 \\
PTA4 + Age             & 0.968 & 0.801 & 0.744 \\
PTA4 + Age + Sex       & 0.968 & 0.797 & 0.745 \\
Matched HTL + Age      & 0.958 & \textbf{0.833} & \textbf{0.763} \\
\bottomrule
\end{tabular}
\end{table}
...
item.  The finding that age improves NHANES AUQ054 AUROC by $+0.054$
