...
positive rate 47.8\%).  A secondary outcome was AUQ101
...
AUROC\,=\,0.747 for predicting NHANES general hearing difficulty (AUQ054)---above
...
to 0.801 ($\Delta=+0.054$), corroborating that age is an informative predictor
beyond threshold sensitivity.  The matched 8-frequency HTL model achieves
AUROC\,=\,0.833.  For the speech-in-noise specific item (AUQ101, $\leq$2
coded as positive), transfer AUROCs are somewhat lower but still well above
chance (PTA4-only: 0.695; PTA4+Age: 0.744; matched HTL+Age: 0.763),
...
(AUQ054 AUROC 0.75--0.83; AUQ101 AUROC 0.69--0.76) suggest that OHHR-trained
...
Adding age raises NHANES AUQ054 AUROC by $+0.054$, corroborating the
